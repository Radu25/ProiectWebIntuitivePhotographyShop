...
function loginForm(){
    ...
    <a href="../phpPagesForUsers/index.php" class="btn">Exit</a>
  </div>';
}
...
<html lang="en">
    <head>
        ...
        <title>Community Chat IPS</title>
    ...
    <p align="left" style="padding-left: 25px;">
                <a style="padding-left: 25px;" class="btn" id="btnsmecher" href="../phpPagesForUsers/index.php"> Exit chat &#128281;</a>
            </p>
</html>
<?php
}
